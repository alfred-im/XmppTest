...
### Client legacy React (`web-client/`, tag `legacy/web-client-final`)

Solo se si recupera il client storico: `npm run build` in `web-client/`.
...
**Ricorda: NON sviluppare automaticamente - aspettare comando esplicito. La Mappa del Progetto è il CONTRATTO. Il Metodo Analitico è la base di tutto. Ogni altra regola si applica attraverso il metodo analitico.**
