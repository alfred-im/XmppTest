...
- ✅ **Se analizzando il codice scopri che funziona DIVERSAMENTE da come lo avevi "pensato" leggendo la mappa, la mappa è INCOMPLETA e va ARRICCHITA immediatamente**
...
- ❌ **NON presumere che la mappa sia completa se il codice ti sorprende - aggiornala**
...
**Se scopri discrepanze tra mappa e codice reale:**
- La mappa dice X ma il codice fa Y
- Hai "pensato" che funzionasse in un modo ma analizzando vedi che è diverso
- Trovi implementazioni non documentate nella mappa
- Trovi pattern o convenzioni non menzionate nella mappa

**AZIONE OBBLIGATORIA**: Fermarsi e aggiornare la mappa IMMEDIATAMENTE con le informazioni corrette.

**Motivo**: Se la mappa ti ha portato a fare assunzioni sbagliate, porterà anche sessioni future a fare gli stessi errori. La mappa deve essere SEMPRE più accurata del tuo "pensiero" iniziale.
...
9. **Auto-correzione continua**: Ogni discrepanza trovata arricchisce la mappa, rendendola sempre più accurata
10. **Previene assunzioni ripetute**: Se il codice ti sorprende, la mappa viene corretta per evitare sorprese future
