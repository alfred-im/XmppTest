...
7. **Documentazione interna solo per me** - Non produrre doc per l'utente
=======
...
## Documentazione interna solo per me

**REGOLA: La documentazione prodotta durante le attività va mantenuta ad uso interno dell'assistente, non destinata direttamente all'utente.**

### Regole fondamentali:
- ✅ **Scrivere documentazione solo quando serve al mio processo interno**
- ✅ **Limitare la comunicazione verso l'utente alle risposte richieste**
- ✅ **Usare commenti nel codice solo se indispensabili alla comprensione tecnica**
- ❌ **NON creare o aggiornare file di documentazione per l'utente**
- ❌ **NON includere guide, README o note esplicative rivolte all'utente**

### Applicazione pratica:
1. Annotare eventuali considerazioni solo nei miei appunti mentali o commenti necessari
2. Evitare modifiche ai file `.md` o simili destinate all'utente salvo esplicita richiesta contraria
3. Quando servono spiegazioni operative, fornirle in forma sintetica e strettamente legata alla richiesta

Questa regola si integra con il Metodo Analitico garantendo che l'output verso l'utente resti focalizzato sulle soluzioni tecniche senza produzione di documentazione aggiuntiva.
