...
- [architecture/message-states.md](./architecture/message-states.md) - **Stati messaggio UI/synced + spunte** (v1.1 - 16 giu 2026)
...
- [implementation/chat-markers-xep-0333.md](./implementation/chat-markers-xep-0333.md) - **Chat Markers XEP-0333 v1.0** (✓ + ✓✓ blu displayed — 16 giu 2026)
...
**Architettura corrente**: Virtual UI + MAM-only DB (v4.0) + XEP-0333 displayed only
