...
- [decisions/address-based-messaging.md](./decisions/address-based-messaging.md) - **🟢 Regola vincolante** — messaggistica per indirizzo; inbox = storico messaggi; rubrica isolata (2026-06-27)
