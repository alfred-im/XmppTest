...
| **SYS-PUSH** | Web Push VAPID, subscription, Edge Function | `draft` | [SYS-PUSH.md](./promises/system/SYS-PUSH.md) |
...
| **PROM-PUSH-NOTIFY** | Push multi-device / multi-account, anteprima, soppressione | `draft` | [PROM-PUSH-NOTIFY.md](./promises/product/PROM-PUSH-NOTIFY.md) |
...
| **SURF-NOTIFICATIONS** | Web Push, service worker, permesso browser | `draft` | PROM-PUSH-NOTIFY, SYS-PUSH | [SURF-NOTIFICATIONS.md](./surfaces/SURF-NOTIFICATIONS.md) |
