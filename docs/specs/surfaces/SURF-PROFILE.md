...
| **Supersedes** | PROFILE schermata REQ-003, 005, 007–009, 012–013, 016 (SDD v1 epurato) |
| **PR** | #118, #134 |
...
| PROFILE-REQ | SURF-ID |
|-------------|---------|
| REQ-003 | SURF-PROFILE-001 |
| REQ-005 | SURF-PROFILE-003 |
| REQ-007 | SURF-PROFILE-004 |
| REQ-008 | SURF-PROFILE-005 |
| REQ-009 | SURF-PROFILE-006 |
| REQ-012 | SURF-PROFILE-008 |
| REQ-013 | SURF-PROFILE-009 |
| REQ-016 | SURF-PROFILE-015 |

Backend (tabella, RLS, RPC): [SYS-PROFILE.md](../promises/system/SYS-PROFILE.md).

---

## 4. Tracciabilità

| SURF-ID / PROFILE-REQ | Verifica |
|-----------------------|----------|
| SURF-PROFILE-001, REQ-003 | `profile_screen.dart` — email disabilitata |
| SURF-PROFILE-002, REQ-016 | `profile_screen.dart` — username read-only |
| SURF-PROFILE-003, REQ-005 | `profile_service.dart` — `.from('profiles').update()` |
| SURF-PROFILE-004, REQ-007 | `models_and_utils_test.dart` — `ProfileSummary.fromProfilesRow` |
| SURF-PROFILE-005, REQ-008, REQ-013 | `models_and_utils_test.dart` — `avatarColorForId`; `widgets/profile_identity.dart` |
| SURF-PROFILE-006, REQ-009 | `account_storage_test.dart` — `OpenAccount.profile` round-trip; `auth_controller.dart` `refreshProfile` |
| SURF-PROFILE-007, REQ-006 | `profile_avatar_service.dart`; `profile_screen.dart` picker |
| SURF-PROFILE-008, REQ-012 | `models_and_utils_test.dart` — `UserProfile.fromJson` |
