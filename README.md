...
Migrazione verso **Flutter + Supabase + bridge Python** (`docs/decisions/project-revolution-discovery.md`). PR Alpha **#108–#127** mergiate su `main`; **#129** message-centric in PR (registro: `docs/architecture/alpha-pr-registry.md`).
